...
!!!
CSV.write("1calibration/02.Identification_results/Identification_df_Auto1_wage.csv", Identification_df)

# Firstload dataframe
Identification_df = CSV.read("1calibration/02.Identification_results/Identification_df_Auto1_wage.csv",
                             DataFrame; copycols = true, typemap = Dict(Int64=>Float64))


# Function
function Identification_df_Auto1_wage(α = 0.25,ν = 0.60; #KEY
                          ϕk_lower = 0.0,
                          ϕk_upper = 2.4,
                          ξbar_lower = 0.0,
                          ξbar_upper = 1.0,
