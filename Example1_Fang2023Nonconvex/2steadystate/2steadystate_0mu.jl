...
CSV.write("2steadystate/InvestmentRate_0mu.csv", data)
...
CSV.write("2steadystate/Prob_of_Adjustment_0mu.csv", data)
...
### Save Results
CSV.write("2steadystate/transition_0mu.csv", tr_output)
# Readback
tr_output = CSV.read("2steadystate/transition_0mu.csv",  copycols = true, typemap = Dict(Int64=>Float64))
